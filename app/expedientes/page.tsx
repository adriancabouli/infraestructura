                      ...
                      return (
                        <tr key={r.id} className="hover:bg-zinc-50">
                          ...
                          <Link
                              ...
                              className="expediente_title_lista inline-flex items-start gap-2 font-semibold text-zinc-900 hover:underline"
                            >
                              <svg
                                ...
                                className="h-4 w-4 shrink-0 mt-[2px] text-[#005e9a]"
                                aria-hidden="true"
                              >
